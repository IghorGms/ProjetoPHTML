...
if (empty($_SESSION['errors'])) {
    ...
    header("Location: ConfirmarDados.php?Nome=" . urlencode($Nome) . "&Sobrenome=" . urlencode($Sobrenome) . "&email=" . urlencode($email) . "&telefone=" . urlencode($telefone) . "&idade=" . urlencode($idade) . "&opinion=" . urlencode($opinion));    exit; 
} 
